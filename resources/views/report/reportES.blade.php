    ...
    <div class="col-lg-12">
        ...
        <div class="box box-danger">
            <div class="box-header with-border">
                ...
                @include('layouts.usermanual', ['link' => "http://192.168.1.233:8080/dokuwiki/doku.php?id=wiki:reportees"])
                ...
                <div class="box-body" id="reportApp">
                    ...
                    <div class="row" v-if="oData.reportType == 1">
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <select data-placeholder="Selecciona opciones..." style="width: 60%" class="chosen-select" id="vals" name="vals[]" multiple required>
