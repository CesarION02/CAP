            ...
            <form action="{{ route(''.$sRoute.'') }}" id="theForm">
                 <div class="box-body" id="reportApp">
                    ...
                    <div>
                        <div class="row">
                            <div class="col-md-2">
                                Modificaciónes a tiempo extra:*
                            </div>
                            <div class="col-md-7 col-md-offset-1">
                                <select  name="typeChange" id="typeChange" class="form-control" data-placeholder="Selecciona opción">
                                    <option value="0">Todas</option>
                                    <option value="1">Agregar TE</option>
                                    <option value="2">Descontar TE</option>
                                </select>
                            </div>
                        </div>
                        <br>
