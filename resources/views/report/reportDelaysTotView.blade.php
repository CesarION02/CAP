            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    @if( isset($wizard) )
                        @if( $wizard != 2 )
                            <div class="col-md-2">
                                <a href="{{ route('generarreportetiemposextra', 0) }}" target="_blank" class="btn btn-success">Nuevo reporte</a>
                            </div>
                        @endif
                    @else
                        <div class="col-md-2">
                        ...
                        <thead>
                            ...
                            @if( isset($wizard) )
                                @if( $wizard != 2)
                                    ...
                                    <a href="{{ route('generarreportetiemposextra', 0) }}" target="_blank" id="newButton" title="Nuevo reporte">Nuevo reporte</a>
                                @endif
                            @else
                                <button onclick="reloadFunction()" id="reloadBtn" title="Recargar reporte">Actualizar</button>
                                <button onclick="topFunction()" id="myBtn" title="Ir arriba">Ir arriba</button>
