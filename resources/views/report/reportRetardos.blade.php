...
@section("scripts")
    ...
    <script>
        function GlobalData () {
            ...
            this.hiddenCol = [3,4,5,6,8,9,10,11,12,13,14];
    ...
    <script src="{{asset("assets/pages/scripts/report/SExportDelay.js")}}" type="text/javascript"></script>
@endsection