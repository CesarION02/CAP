...
@section('styles1')
    ...
    <link rel="stylesheet" href="{{ asset("assets/css/reportChangeHrEx.css") }}">
    ...
    <div class="col-lg-12">
        ...
        <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title">Reporte de modificaciónes de tiempo extra</h3>
            ...
            <div class="box-body" id="reportDelayApp">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2" style="text-align: right">
                        <a href="{{ route('datosreportecambiohorasextra') }}" target="_blank" class="btn btn-success">Nuevo reporte</a>
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-md-12">
                        <table id="delays_table" class="table table-condensed" style="width:100%">
                            ...
                            <a href="{{ route('datosreportecambiohorasextra') }}" target="_blank" id="newButton" title="Nuevo reporte">Nuevo reporte</a>
                        </table>
                    </div>
                </div>
            </div>
...
@section("scripts")
    ...
    <script src="{{asset("assets/pages/scripts/report/SChangeHrEx.js")}}" type="text/javascript"></script>
