    ...
    <div class="col-lg-12">
        ...
        <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title">Reporte revisión número checadas</h3>
                @include('layouts.usermanual', ['link' => "http://192.168.1.251/dokuwiki/doku.php?id=wiki:reporterevisionnumerochecadas"])
                <div class="box-tools pull-right">
                </div>
            </div>
            <form action="{{ route('generar_numero') }}">
