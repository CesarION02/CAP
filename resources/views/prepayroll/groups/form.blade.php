...
<div class="row">
        <div class="form-group">
          <label for="" class="col-lg-3 control-label">Gpo prenómina padre:</label>
          <div class="col-md-5 ">
...
<div class="row">
    <div class="form-group">
      <label for="" class="col-lg-3 control-label">Usuarios encargados:</label>
      <div class="col-md-5 ">
        <select class="chosen-select" name="head_users[]" multiple="multiple" style="width: 100%;" data-placeholder="Elige opciones">
