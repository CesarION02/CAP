...
<script>
    function GlobalData () {
        this.getDeptoProgRoute = <?php echo json_encode($getDeptoProgRoute); ?>;
...
<script src="{{ asset("assets/pages/scripts/assign/vueDeptoProgramming.js") }}" type="text/javascript"></script>
@endsection

@section('content')
<div class="row" id="deptoPrograming">
    <div class="col-lg-12">
        ...
        <div class="box box-danger">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="{{route('index_deptoProgramming')}}" class="btn btn-block btn-info btn-sm">
            ...
            <form id="form-general" class="form-horizontal" autocomplete="off">
                <div class="box-body">
                    @include('assign.formDeptoProgramming')
                </div>
                <div class="box-footer">
                    <div class="col-lg-3"></div>
                    <div class="col-lg-6">
                        <button type="button" class="btn btn-success" id="guardar" v-on:click="getDeptoProgamming();">Guardar</button>
                    </div>
                </div>
            </form>
        </div>
