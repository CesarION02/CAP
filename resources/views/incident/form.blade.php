<div class="form-group">
    <label for="Tipoincidente" class="col-lg-3 control-label requerido">Tipo Incidente:</label>
    <div class="col-lg-8">
...
<div class="form-group">
    <label for="start_date" class="col-lg-3 control-label requerido">Fecha Inicio</label>
    <div class="col-lg-8">
        <input type="date" class="form-control" name="start_date" id="start_date" value="{{old('start_date', $data->start_date ?? '')}}" class="form-control">
    </div>
</div>
<div class="form-group">
        <label for="end_date" class="col-lg-3 control-label requerido">Fecha Fin</label>
        <div class="col-lg-8">
