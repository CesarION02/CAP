            ...
            <div class="box-header with-border">
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-4">
                        <div class="row">
                            <div class="col-md-9">
                                <form action="{{ route('control_semana') }}">
                ...
                <table class="table table-striped table-bordered table-hover" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$semanas->year}}</td>
                            <td>{{$semanas->num}}</td>
                            <td>{{\App\SUtils\SDateTimeUtils::orderDate($semanas->ini)}}</td>
                            <td>{{\App\SUtils\SDateTimeUtils::orderDate($semanas->fin)}}</td>
                            <td>
                                @if($semanas->status == 0)
                                    Creado
                                @elseif($semanas->status == 1)
                                    Visto bueno
                                @else
                                    Procesada
                                @endif
