function agregar() {
    ...
    var nameDiv = "div";
    nameDiv += contador;
    var div = '<div class="form-group ' + nameDiv + '"><label class="col-lg-3 control-label requerido">Plantilla:</label><div class="col-lg-4"><select name="horario' + contador + '" id="horario' + contador + '">'
    $.ajax({
        type: 'get',
